    ...
    <main class="flex-1 p-6 relative">
        ...
        <header class="mb-6 flex justify-between items-center">
            <div>
                ...
                <h1 class="text-[#4B2E0E] font-semibold text-xl">Products</h1>
            </div>
            <button id="add-product-btn"
                    class="bg-[#C4A07A] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#a17850] transition">
                Add Product
            </button>
        </header>
                        ...
                        <tr class="border-b">
                            <td class="px-6 py-4">
                                <img src="<?= $p['image'] ?: 'https://placehold.co/50x50/png?text=' . urlencode($p['name']) ?>"
                                     alt="<?= htmlspecialchars($p['name']) ?>" class="w-12 h-12 object-cover rounded">
                            </td>
                            <td class="px-6 py-4"><?= htmlspecialchars($p['sku']) ?></td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <button class="text-red-600 hover:text-red-800 ml-2 delete-btn"
                                    data-id="<?= $p['id'] ?>">
        ...
        <div class="bg-white rounded-lg p-6 w-96">
            ...
            <form id="product-form">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="product-sku" name="sku" class="w-full border-gray-300 rounded-md shadow-sm" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700">Name</label>
                    <input type="text" id="product-name" name="name" class="w-full border-gray-300 rounded-md shadow-sm" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700">Description</label>
                    <textarea id="product-description" name="description" class="w-full border-gray-300 rounded-md shadow-sm"></textarea>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700">Price</label>
                    <input type="number" step="0.01" id="product-price" name="price" class="w-full border-gray-300 rounded-md shadow-sm" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700">Category</label>
                    <input type="text" id="product-category" name="category" class="w-full border-gray-300 rounded-md shadow-sm" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700">Stock</label>
                    <input type="number" id="product-stock" name="stock" class="w-full border-gray-300 rounded-md shadow-sm" required>
                </div>
                <div class="mb-3">
                    <label class="block text-sm font-medium text-gray-700">Image URL</label>
                    <input type="url" id="product-image" name="image" class="w-full border-gray-300 rounded-md shadow-sm">
                </div>
                <div class="flex justify-end space-x-2">
                    <button type="button" id="cancel-modal" class="bg-gray-300 text-gray-700 px-4 py-2 rounded">Cancel</button>
                    <button type="submit" class="bg-[#C4A07A] text-white px-4 py-2 rounded">Save</button>
                </div>
            </form>
        </div>
    </div>
