    ...
    <body class="min-h-screen flex">
        <!-- Sidebar -->
        <div class="sidebar">
            <a href="dashboard.php" title="Dashboard"><i class="fas fa-chart-line"></i></a>
            <a href="page.php" title="Cart"><i class="fas fa-shopping-cart"></i></a>
            <a href="../all/tranlist.php" title="Order List"><i class="fas fa-list"></i></a>
            <a href="product.php" title="Products"><i class="fas fa-box"></i></a>
            <a href="user.php" title="Users"><i class="fas fa-users"></i></a>
